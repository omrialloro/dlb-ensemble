...
export function NewFrame(props) {
  ...
  return (
    <div style={{display:'flex'}}>
      ...
      <div className="msg">
        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 49 49"><defs><style>.cls-1</style></defs><polygon class="cls-1" points="49 21 28 21 28 0 21 0 21 21 0 21 0 28 21 28 21 49 28 49 28 28 49 28 49 21"/></svg>
